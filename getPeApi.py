...
try:
    while True:
        print(f"🔄 Buscando registros a partir do offset {offset}...")
...
df.to_csv("servidores_PE.csv", index=False, encoding="utf-8", sep=";")

print("✅ Arquivo servidores_PE.csv gerado com sucesso!")
